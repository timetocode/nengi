...
function createGrid2D() {
    return new SpatialGrid_1.SpatialGrid2D({
        cellSize: 10,
        getX: obj => obj.x,
        getY: obj => obj.y
    });
...
function createGrid3D() {
    return new SpatialGrid_1.SpatialGrid3D({
        cellSize: 10,
        getX: obj => obj.x,
        getY: obj => obj.y,
        getZ: obj => obj.z
...
describe('SpatialGrid2D', () => {
    ...
    it('adds objects, initializes cells, and tracks object cell refs', () => {
        const initialized = [];
        const grid = new SpatialGrid_1.SpatialGrid2D({
            cellSize: 10,
            getX: obj => obj.x,
            getY: obj => obj.y,
    ...
    it('uses swap-remove and updates the moved object ref', () => {
        ...
        expect(removed === null || removed === void 0 ? void 0 : removed.removedCell).toBe(false);
    ...
    it('deletes empty cells on remove', () => {
        ...
        grid.add(1, { x: 1, y: 1 });
        const removed = grid.remove(1);
        expect(removed === null || removed === void 0 ? void 0 : removed.removedCell).toBe(true);
...
describe('SpatialGrid3D', () => {
    ...
    it('moves objects across 3D cells', () => {
        ...
        object.z = -1;
        const move = grid.update(1, object);
        expect(move === null || move === void 0 ? void 0 : move.fromCell).toBe('0:0:0');
        expect(move === null || move === void 0 ? void 0 : move.toCell).toBe('0:2:-1');
        expect(move === null || move === void 0 ? void 0 : move.removedCell).toBe(true);
        expect(move === null || move === void 0 ? void 0 : move.createdCell).toBe(true);
