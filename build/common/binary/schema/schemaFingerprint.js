...
exports.createSchemaFingerprint = createSchemaFingerprint;
exports.describeSchemaFingerprint = describeSchemaFingerprint;
function stableSchemaString(schemas) {
...
function createSchemaFingerprint(context) {
    return fnv1a32(stableSchemaString(context.schemas));
}
function describeSchemaFingerprint(context) {
