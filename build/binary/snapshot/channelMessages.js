...
exports.addChannelMessages = addChannelMessages;
function addChannelMessages(plan, user, channel, includeBroadcastMessages) {
...
function addScopedQueuedMessages(plan, user, channelId) {
